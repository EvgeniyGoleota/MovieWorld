...
interface MovieApi {
    ...
    fun getPersonsCombinedCredits(@Path("person_id") personId: Int): Flowable<ACreditsResponse>
    ...
    fun getMovieCredits(@Path("movie_id") movieId: Int): Flowable<MCreditsResponse>
